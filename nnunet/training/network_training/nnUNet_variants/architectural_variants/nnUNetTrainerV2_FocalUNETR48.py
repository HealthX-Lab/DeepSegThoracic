...
class nnUNetTrainerV2_FocalUNETR48(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = FocalUNETR(
            img_size=96, num_classes=self.num_classes, in_chans=self.num_input_channels, embed_dim=48,
