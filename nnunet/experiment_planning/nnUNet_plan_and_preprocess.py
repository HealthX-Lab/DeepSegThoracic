...
def main():
    import argparse
    os.environ['nnUNet_raw_data_base'] = 'D:/Arash/AnatomySegmentation/nnUNet_raw_data_base'
    os.environ['nnUNet_preprocessed'] = 'C:/Training/nnUNet_preprocessed'
    os.environ['RESULTS_FOLDER'] = 'C:/Training/nnUNet_trained_models'
